...
public class ItemOriginBackTrackMachine extends AbstractElectricRecipeMachine {
    ...
    private static final ItemStack PROGRESS_STACK = new CustomItemStack(Material.SOUL_CAMPFIRE, getGradientName("Information"), getGradientName("Type: Template Machine"), getGradientName("Addon: MagicExpansion"));
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (MachineRecipe recipe : recipes) {
            ...
            for (int i = 0; i < maxItems; i++) {
                ...
                if (i < inputs.length) {
                    if (i == 0) {
                        display.add(addLore(inputs[i], "§e§l☞any materials☜"));
                    } else {
