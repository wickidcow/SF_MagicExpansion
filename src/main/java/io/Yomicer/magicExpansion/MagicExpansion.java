...
public class MagicExpansion extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        FishingIntegrationManager.initialize(this);
        ...
        // The scheduler stays idle unless the optional Magic-owned Water Cloud
        // state machine is enabled and no external fishing provider is primary.
    ...
    private void renameMainGuideCategory() {
        try {
            ...
            ItemStack displayItem = (ItemStack) displayItemField.get(MagicExpansionItemSetup.magicexpansion);
            ...
            getLogger().warning("Could not rename the Magic guide category: " + exception.getMessage());
        }
    }
